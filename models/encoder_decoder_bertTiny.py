...
"""
These three functions overwrite the forward pass methods of the encoder-decoder bert-tiny.
This code is heavily based on the Hugging Face code, taken from https://github.com/huggingface/transformers/blob/v4.25.1/src/transformers/models/bert/modeling_bert.py
