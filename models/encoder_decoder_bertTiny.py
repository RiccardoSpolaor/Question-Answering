...
This code is heavily based on the huggin face code, taken from https://github.com/huggingface/transformers/blob/v4.25.1/src/transformers/models/bert/modeling_bert.py
